...
if( $_SERVER["REQUEST_METHOD"] == "POST")
{
		...
		$sql = 'INSERT INTO WorkOrders (WorkOrderName, DateNeeded, Priority, DayEstimate, Revision, Requestor, Completed, ' 
			.  'Project, RequestingIPTGroup, ReceivingIPTGroup,RequestingIPTLeadApproval, AssignedIPTLeadApproval, ProjectOfficeApproval, DateRequested, Description) ';
			$sql .= ' VALUES(';
		$sql .= '  "' . $WorkOrderName  . '"';
		$sql .= ', "' . $DateNeeded    . '"';
		$sql .= ', "' . $Priority  . '"';
