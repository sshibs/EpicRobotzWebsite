...
echo '<form action= "workorder_addnew.php" method="post">';
...
echo "  <option value=\"jan\">01</option>";
echo "  <option value=\"feb\">02</option>";
echo "  <option value=\"mar\">03</option>";
echo "  <option value=\"apr\">04</option>";
echo "  <option value=\"may\">05</option>";
echo "  <option value=\"jun\">06</option>";
echo "  <option value=\"jul\">07</option>";
echo "  <option value=\"aug\">08</option>";
echo "  <option value=\"sep\">09</option>";
echo "  <option value=\"oct\">10</option>";
echo "  <option value=\"nov\">11</option>";
echo "  <option value=\"dec\">12</option>";
