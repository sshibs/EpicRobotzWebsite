<?php
// --------------------------------------------------------------------
// members_adduser_form.php -- HTML fragment to show the add_user form.
//
// Created: 12/30/14 DLB
// --------------------------------------------------------------------

echo '<div class="content_area">';
echo '<h2 class="page_title">Add New Member</h2>' . "\n";
...
echo '<form action="members_adduser.php" method="post">' . "\n";
