...
echo '<h2 class="page_title">Create New Workorder form</h2>' . "\n";
...
echo '<form action="Workorder_Test.php" method="post">' . "\n";

RenderParams($param_list);

echo '<input class="inputform_submit_button" type="submit" value="Add Workorder">' . "\n";
echo '</form></div>' . "\n";
